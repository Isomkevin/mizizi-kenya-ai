...
├── LOCAL.md             ← local dev
├── render.yaml          ← Render Blueprint (NOT a Dockerfile)
...
> If you see `unknown instruction: services:`, you pointed Docker at `render.yaml` by mistake.

1. [Render Dashboard](https://dashboard.render.com) → **New** → **Blueprint**
2. Connect repo → Blueprint path: **`deploy/masumi/render.yaml`**
