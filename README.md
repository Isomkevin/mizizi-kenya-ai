...
- **UX philosophy** – intentionally _lovable_; the goal is a domain‑specific UI that feels natural to agronomists, not a generic SaaS template.
...
- **Routes** live under `src/routes/`. Do _not_ touch `routeTree.gen.ts`.
