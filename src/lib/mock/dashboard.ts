...
export const welcomeSnapshot: WelcomeSnapshot = {
  ...
  summary:
    "Three items need your attention. Nothing critical. Rainfall variance in Nyandarua is the most material — Mizizi has drafted a buffer recommendation for your review.",
  weatherInsight: "Above-normal rainfall expected in Rift Valley this season",
  pendingApprovals: 14,
...
export const dashboardInsights: DashboardInsight[] = [
  ...
  },
  {
    ...
    why: "Dry spell risk in lower Rift zones may affect harvest income this season.",
    icon: "climate",
    severity: "medium",
  },
  {
    ...
    body: "Combined on-time rate rose to 96% after verifying shared supplier links.",
  ...
  {
    id: "ins-4",
    title: "Possible duplicate borrower records",
    body: "4 pairs flagged in Meru — identity match review recommended.",
    why: "Matching national ID fragments and mobile money account handles.",
    icon: "duplicate",
    severity: "medium",
  },
];
...
export const recentActivity: ActivityItem[] = [
  ...
  },
  {
    ...
    message: "Rainfall outlook flagged 3 cooperatives in Nyandarua for review",
  ...
  },
  {
    ...
    timestamp: "09:14",
    type: "graph-updated",
    message: "12 borrowers linked to Mwea Cooperative after profile enrichment",
    actor: "Data team",
    confidence: 0.89,
    risk: "low",
  },
  {
    ...
    message: "Decision audit completed for 482 Q3 applications",
    actor: "Compliance",
    confidence: 0.91,
    risk: "low",
  },
...
export const quickActions: QuickAction[] = [
  ...
  {
    id: "qa-4",
    label: "Check climate exposure",
    description: "Latest rainfall and drought outlook by county",
    href: "/app/climate",
  },
  {
    id: "qa-5",
    label: "Export report",
    description: "Download portfolio risk snapshot",
    href: "/app/analytics",
  },
  {
    id: "qa-6",
